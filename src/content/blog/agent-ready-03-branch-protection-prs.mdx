...
heroImagePrompt: 'Abstract visualization of git branching with protected main branch as a fortress, PR workflows as secure pathways with validation gates, CI/CD pipelines flowing as streams of light, geometric shapes representing code reviews and automated checks, dark background with blue and green accents, professional tech aesthetic, 16:9 aspect ratio'
