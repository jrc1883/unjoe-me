...
heroImagePrompt: 'Complex monorepo structure visualization with multiple apps and packages interconnected, workspace organization with shared dependencies flowing between projects, turborepo build pipeline as cascading streams, geometric tree structure with glowing connection points, dark background with orange and blue highlights, professional tech aesthetic, 16:9 aspect ratio'
