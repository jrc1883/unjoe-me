...
heroImagePrompt: 'A modern, minimalist technical diagram showing a monorepo structure with shared dependencies and build orchestration on a dark navy blue background (#0a0a0b to #1a1a2e gradient).
