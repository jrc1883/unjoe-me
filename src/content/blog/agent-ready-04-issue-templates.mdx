...
heroImagePrompt: 'Organized grid of structured issue cards with fields and checkboxes, representing bug reports and feature requests, flowing into an AI processing system with glowing connections, geometric organization, dark background with yellow warning highlights and green success indicators, professional tech aesthetic, 16:9 aspect ratio'
