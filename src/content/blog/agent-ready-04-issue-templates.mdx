...
heroImagePrompt: 'A modern, minimalist technical diagram showing GitHub Issue Template forms with structured fields on a dark navy blue background (#0a0a0b to #1a1a2e gradient).
