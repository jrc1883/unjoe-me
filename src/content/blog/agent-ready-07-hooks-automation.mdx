...
heroImagePrompt: 'A modern, minimalist technical diagram showing Git Hooks workflow as an automated quality gate system on a dark navy blue background (#0a0a0b to #1a1a2e gradient).
...
COMPOSITION:
- Left-to-right flow (command → hooks → outcome)
