...
heroImagePrompt: 'Automated quality gate system with git hooks as checkpoints, code flowing through validation pipelines with lint, test, and security checks, cascade of automated processes catching errors, dark background with red warning indicators and green success checkmarks, professional tech aesthetic, 16:9 aspect ratio'
...
*[← Part 6: Documentation as Context](./06-documentation-context.md) | [Part 8: Monorepo Architecture →](./08-monorepo-architecture.md)*
