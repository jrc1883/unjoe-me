...
heroImagePrompt: 'A modern, minimalist technical diagram showing PopKit orchestration system unifying all agent-ready development practices on a dark navy blue background (#0a0a0b to #1a1a2e gradient).
