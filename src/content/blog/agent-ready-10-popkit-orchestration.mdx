...
heroImagePrompt: 'Complete orchestration system with all agent-ready development practices unified in a cohesive workflow dashboard, 7-phase development pipeline visualization, interconnected tools and processes flowing harmoniously, geometric symphony of automation and structure, dark background with rainbow spectrum highlights representing different workflow phases, professional tech aesthetic, 16:9 aspect ratio'
