...
heroImagePrompt: 'Split-screen comparison on dark navy blue background (#0a0a0b). LEFT SIDE (40% width): Chaotic repository with randomly scattered files - "utils_final.js", "new_utils.js", "test.js", "helpers2.js" jumbled together with red warning glow, tangled connecting lines. RIGHT SIDE (60% width): Organized repository tree structure showing "my-project/" root folder (3D rounded rectangle with electric blue glow #3b82f6) containing: ".github/" folder with "workflows/ci.yml" file, "src/" folder with organized subfolders "components/", "services/", "utils/", "types/" clearly labeled, "CLAUDE.md" file with bright blue highlight, "README.md", "package.json". Clean tree structure with thin blue connecting lines showing hierarchy. Folders as 3D rounded rectangles, files as flat rectangles with appropriate icons. Monospace font (Fira Code) for filenames, sans-serif for folders. Subtle shadows for depth. Center dividing line with subtle glow separating chaos from order. 16:9 landscape (1792x1024), high contrast, professional tech aesthetic.'
