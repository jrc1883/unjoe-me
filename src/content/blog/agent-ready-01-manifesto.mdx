...
RED FLAGS visible: mixed .js/.ts/.jsx extensions, duplicate files (utils variants), multiple package managers, vague folder names (stuff/, misc/), inconsistent naming (Component vs component).
...
TECHNICAL: 16:9 landscape (1792x1024), high contrast, readable at thumbnail size, minimal text, clear visual hierarchy.'
