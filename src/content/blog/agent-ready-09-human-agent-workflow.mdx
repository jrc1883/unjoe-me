...
heroImagePrompt: |
  A modern, minimalist technical diagram showing human-AI pair programming workflow with iterative feedback loops on a dark navy blue background (#0a0a0b to #1a1a2e gradient).
