...
heroImagePrompt: 'Layered documentation system with architecture diagrams, ADRs, and API specs flowing into an AI knowledge processor, interconnected knowledge graph visualization, code snippets transforming into structured data, dark background with cyan and white highlights, professional tech aesthetic, 16:9 aspect ratio'
