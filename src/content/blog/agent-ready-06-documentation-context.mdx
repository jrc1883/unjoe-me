...
heroImagePrompt: |
  A modern, minimalist technical diagram showing a layered documentation hierarchy feeding into AI context on a dark navy blue background (#0a0a0b to #1a1a2e gradient).
