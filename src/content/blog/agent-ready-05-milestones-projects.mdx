...
heroImagePrompt: 'A modern, minimalist technical diagram showing GitHub Project Board with Milestones and Kanban workflow on a dark navy blue background (#0a0a0b to #1a1a2e gradient).
